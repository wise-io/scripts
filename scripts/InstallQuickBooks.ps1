...
$QBVersions = @(
  ...
  [PSCustomObject]@{Name = 'QuickBooks Enterprise 23'; ProductNumber = '538185'; URL = 'https://dlm2.download.intuit.com/akdlm/SBD/QuickBooks/2023/Latest/QuickBooksEnterprise23.exe'; }

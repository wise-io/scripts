...
$QBVersions = @(
  ...
  #[PSCustomObject]@{Name = 'QuickBooks Enterprise 24 - Accountant'; ProductNumber = '334562'; URL = 'https://dlm2.download.intuit.com/akdlm/SBD/QuickBooks/2024/Latest/QuickBooksEnterprise24.exe'
